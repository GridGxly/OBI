...
/**
 * Render the authenticated user's profile page showing account details and saved sounds.
 *
 * If no authenticated user is present, redirects to the root path and shows a loading placeholder while authentication state is resolving.
 *
 * @returns A JSX element that displays the user's username, email, member-since date, saved-sounds count, a list of saved sounds (with remove controls), and a Sign Out button.
 */
...
/**
 * Render a card that displays a saved sound's metadata and provides a remove control.
 *
 * Shows an optional match percentage badge, title, BPM, tags, year, and the saved date; the remove button triggers the provided callback.
 *
 * @param sound - The saved sound object to display
 * @param onRemove - Callback invoked when the card's remove button is clicked
 * @returns A React element representing the saved sound card
 */
