...
/**
 * Renders an interactive circular knob control with an arc-based value gauge.
 *
 * @param label - Text label displayed above the knob
 * @param value - Current numeric value shown by the knob
 * @param onChange - Callback invoked with the new rounded value when the user drags to change it
 * @param min - Minimum allowed value (default 0)
 * @param max - Maximum allowed value (default 100)
 * @returns A React element representing the knob control
 */
