...
/**
 * Render a full-screen animated scanning overlay that progresses through four phases and signals completion.
 *
 * @param onComplete - Callback invoked once the overlay finishes its exit transition.
 * @returns The full-screen overlay element that advances phases automatically and calls `onComplete` after the final exit (approximately 3.2s for phase progression plus the exit transition). 
 */
